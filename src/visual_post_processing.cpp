...
int main(int argc, char **argv)
{
    ...
    if (pcl::io::loadPCDFile<pcl::PointXYZ>("/home/workstation2/ws_cross_modal/bags/PCL_visuale_retta_grid.pcd", *cloud) != 0) { return -1; }
    double distanza;
    double dmin = 0.04;
    double soglia = dmin/2;
    ...
    pcl::io::savePCDFile("/home/workstation2/ws_cross_modal/bags/PCL_visuale_retta_proc.pcd", *cloud);
