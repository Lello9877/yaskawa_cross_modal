...
int main(int argc, char **argv)
{
    ...
    ros::NodeHandle nh;
    std::string source_path = "/home/workstation2/ws_cross_modal/bags/bianco_cerchio.pcd";
    std::string destination_path = "/home/workstation2/ws_cross_modal/bags/bianco_cerchio_pre.pcd";

    pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZRGB>);
    if(pcl::io::loadPCDFile<pcl::PointXYZRGB>(source_path, *cloud) != 0) { return -1; }
    std::vector<int> indice;
    float x_min = -0.15, x_max = 0.15;
    float y_min = -0.60, y_max = -0.10;
    float z_min = 0.08, z_max = 0.27;

cloud->points.at(1).x = 0.0;
